...
lastmod: 2026-09-13T00:51:17.169Z
---
> ## Documentation Index
...
| 31  | LastPx               | Decimal      | C        | Fill price. Whole cents by default, or dollars with four decimal places when `UseDollars=Y`. Present only for ExecType=Trade. See [Subpenny Pricing](/fix/subpenny-pricing).                                      |
