...
lastmod: 2025-11-03T03:42:07.099Z
---
          ...
          schema:
            - type: enum<string>
              enum:
                ...
                - closed
              description: >-
                Only return collections of a certain status. Can be unopened,
                open, or closed.
        associated_event_ticker:
          schema:
            - type: string
              description: >-
                Only return collections associated with a particular event
                ticker.
        series_ticker:
          schema:
            - type: string
          ...
          schema:
            - type: string
              description: >-
                ...
                the pagination. This optional parameter, when filled, should be
                filled with the cursor string returned in a previous request to
                this end-point.
      header: {}
      cookie: {}
    body: {}
