...
lastmod: 2025-11-17T18:04:50.809Z
---
# Get Markets
      ...
      query:
        ...
        status:
          schema:
            - type: string
              description: >-
                Filter by market status. Comma-separated list. Possible values
                are 'unopened', 'open', 'closed', 'settled'. Leave empty to
                return markets with any status.
        tickers:
          schema:
            - type: string
              description: >-
          ...
          - type: object
            properties:
              ...
              cursor:
                allOf:
                  - type: string
            refIdentifier: '#/components/schemas/GetMarketsResponse'
            requiredProperties:
              - markets
              - cursor
        examples:
